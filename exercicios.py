...
Numero11 = int(input("Digite o primeiro valor: "))
Numero22 = int(input("Digite o segundo valor: "))

print(Numero11 * Numero22)

#Faça um programa que peça dois números inteiros e imprima a divisão inteira do primeiro pelo segundo.
Numero111 = int(input("Digite o primeiro valor: "))
Numero222 = int(input("Digite o segundo valor: "))

print(Numero111 / Numero222)

#Escreva um programa que calcule o quadrado de um número fornecido pelo usuário.

Numero1111 = int(input("Digite o primeiro valor: "))
